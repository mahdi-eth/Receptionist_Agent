            ...
            try:
                ...
                try:
                    ...
                    if existing_room:
                        ...
                        print(f"✅ Found existing room {existing_room.room_number}")
                except Exception as ex:
                    print(f"⚠️ Could not retrieve existing room {room_info['room_number']}: {ex}")
        
        print(f"🏨 Created/found {len(created_rooms)} rooms")
        ...
        for guest_info in guest_data:
            try:
                ...
                try:
                    ...
                    print(f"⚠️ Could not retrieve existing guest {guest_info['email']}: {ex}")
        
        print(f"👥 Created/found {len(created_guests)} guests")
